(() => {
    ...
    const buttonPopap = document.querySelector(".button__pay");
    if (iconMenu) {
        iconMenu.addEventListener("click", (function(e) {
            lock.classList.toggle("lock");
            iconMenu.classList.toggle("menu-open");
            menuBody.classList.toggle("menu-open");
            headerFixed.classList.toggle("menu-open");
        }));
        document.addEventListener("keydown", (function(e) {
            ...
            if (27 === keyCode) {
                ...
                headerFixed.classList.remove("menu-open");
            }
        }));
        if (buttonPopap) buttonPopap.addEventListener("click", (function(e) {
            lock.classList.toggle("lock");
            iconMenu.classList.remove("menu-open");
            menuBody.classList.remove("menu-open");
            headerFixed.classList.remove("menu-open");
